...
(function (W) {
  ...
  var protocol = W.location && W.location.protocol == 'https:' ? 'https://' : 'http://';
  ...
  try {
    W = W.inDapIF && (!W.ADventori || !W.ADventori.q) ? W.parent : W;
  } catch(e) {}
  D = W.document;
  ...
  var track = {
    ...
    collect: function (params, opts) {
      ...
      if (transport == 'js') {
        dom.getScript(url, data + '&f=js' + cachebuster);
